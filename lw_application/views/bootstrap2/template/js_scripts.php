...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 ...
 <!-- HTMLs end -->
<!-- SCIPRTs -->
<script src="<?php echo latestFile('assets/js/bootstrap.min.js'); ?>" type="text/javascript" charset="utf-8"></script>
<script src="<?php echo latestFile('assets/js/custom.js'); ?>" type="text/javascript" charset="utf-8"></script>
...
$(document).ready(function() {
  ...
  <?php if(in_array('js_ajax_details', $insertScripts)): ?>
 /*Ajax Product details in Modal*/
    $ModelProductName = $('#myModalLabel');
      $ModelProductData = $('#myModal');
      ...
      $('.show_details_link').on('click', function(e){
        ...
        var toURL = $(this).attr('href');
         ...
         $ModelProductData.html('<div style="padding:10%; text-align:center;">  <img src="<?php echo base_url("assets/img/ajax-loader.gif"); ?>"></br> <?php echo __("Loading..."); ?></div>');
